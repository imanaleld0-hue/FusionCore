...
public class BootstrapActivity extends Activity {
    ...
    public static final String     public static final String EXTRA_TARGET_ORIENTATION = "fusioncore.target_orientation";
    EXTRA_USE_ORIGINAL_LIBUNITY = "og_libunity";
...
new Thread(
    ...
    private void runBootstrapFlow(String targetPackage) {
        ...
        // Activity override from main (new feature)
        ...
        boolean useOriginalLibUnity = getIntent().getBooleanExtra(    public static final String EXTRA_TARGET_ORIENTATION = "fusioncore.target_orientation";
    EXTRA_USE_ORIGINAL_LIBUNITY, false);
        try {
