...
object AuthIntentParser {
    ...
    /**
     * Декодирование Payload части JWT токена без проверки подписи.
     */
    ...
    /**
     * Маскирование токена для безопасного вывода в лог.
     */
